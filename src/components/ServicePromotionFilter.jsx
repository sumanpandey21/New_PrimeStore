...
const ServicePromotion = () => {
  ...
  return (
    <div className="border-b border-gray-200 pb-6">
      <h2 className="text-lg font-semibold mb-4 text-gray-900">Service & Promotion</h2>
      <div className="space-y-3">
        {services.map((service) => (
          ...
          >
            ...
            <span className={`ml-3 text-sm lg:text-base transition-colors duration-150 ${
              service.checked ? 'text-blue-600 font-medium' : 'text-gray-700 group-hover:text-gray-900'
            }`}>
              {service.name}
            </span>
          </label>
